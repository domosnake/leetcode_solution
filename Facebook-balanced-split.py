...
# split the array into two subsequences A and B such that the sum of the integers in both arrays is the same,
...
s = Solution()
a = s.balancedSplitExists([1, 5, 7, 1])
print(a)
a = s.balancedSplitExists([12, 7, 6, 7, 6])
print(a)
